...
def orbitAverages(spacecraft):
    ...
    for i in range(0,len(orbit_numbers)):
        ...
        for j in range(0,len(telems)):
            ...
            #print(range2TelemData)
            #print(len(range2TelemData))
            validTelemData = [x for x in range2TelemData if x<40 and x>-80]; #Within a reasonable range
...
#%% RUN THINGS
getTelemFiles(3,0,3650);
spacecraftTelemStatistics = orbitAverages(spacecraft='3'); #In the order ["F_055", "F_074", "F_047", "F_048", "F_034", "J_236", "J_106", "J_213", "J_216"]
save("./spacecraftTelemStatisticsTest", spacecraftTelemStatistics);
