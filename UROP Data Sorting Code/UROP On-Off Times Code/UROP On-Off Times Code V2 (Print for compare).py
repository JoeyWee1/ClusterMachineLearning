...
for i in range(0,100):
    currentCommand = cleanCommands[satelliteIndex][i]
    currentTime = currentCommand.datetime
    currentRequest = currentCommand.command
    print(currentRequest, " command at ", currentTime)
