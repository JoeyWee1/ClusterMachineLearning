...
for satellite in range(1,5): #The sattelites all orbit near each other so assume start times, end times, and orbit numbers are the same; this loops through all 4 spacecraft, using the information to create orbits for all 4
    createOrbits(loadOrbitInfo("./Inputs/orbit_numbers.npy","./Inputs/orbit_start_times.npy","./Inputs/orbit_end_times.npy",satellite)); #To loop through four spacecraft, just rewrite loadFileInfo to take in the file names as params then loop through array
#Adding temperature telemetry
addTemperatures(loadTemperatureInfo("./Inputs/C1_temperature_statistics.npy",1));
addTemperatures(loadTemperatureInfo("./Inputs/C2_temperature_statistics.npy",2));
addTemperatures(loadTemperatureInfo("./Inputs/C3_temperature_statistics.npy",3));
addTemperatures(loadTemperatureInfo("./Inputs/C4_temperature_statistics.npy",4));
#Adding all of the calibration data
addCalData(loadCalibrationInfo("./Inputs/calvalues.npy","./Inputs/times.npy"));
...
filePath = "unsortedUncleanedOrbitsArray.npy";
