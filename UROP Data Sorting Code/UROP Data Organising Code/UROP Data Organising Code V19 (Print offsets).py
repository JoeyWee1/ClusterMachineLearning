...
#%% TEST
scIndex = 3
for i in range (0, len(cleanedOrbits[scIndex])):
    currentOrbit = cleanedOrbits[scIndex][i]
    currentOffset = currentOrbit.calParams[2][0][0];
    print(currentOffset)

#%% EXPORTING THE ORBIT ARRAY

#npReconstitutedOrbits  = np.array(reconstitutedOrbits);#converts orbits into a numpy array to export
#filePath = "cleanedOrbitsArrayV2(MoreData).npy";
