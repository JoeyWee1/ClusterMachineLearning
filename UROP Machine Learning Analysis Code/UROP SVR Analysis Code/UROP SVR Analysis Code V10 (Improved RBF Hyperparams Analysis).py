...
for sc in range(0,4):
    for c in range (1,110,10): #Tests c in range 0 to 100 in jumps of 10
        for gammax10 in range (1,210, 10): #tests gamma in range 0 to 0.1 in 2000 steps
            gamma = gammax10 / 10;
    ...
    plt.title("Hyperparams for C{}".format(sc+1), )
    plt.xlabel("C");
    plt.ylabel("Gamma")
    plt.colorbar()
    plt.show()
