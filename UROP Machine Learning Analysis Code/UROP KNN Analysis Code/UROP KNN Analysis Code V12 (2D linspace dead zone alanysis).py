...
#%% CREATE 2D LINSPACE
def create2DLinspace(xStart,xEnd,yStart,yEnd,xNum,yNum):
    x = np.linspace(xStart,xEnd,xNum);
    y = np.linspace(yStart,yEnd,yNum);
    return np.meshgrid(x,y);

linspace = create2DLinspace(0,1,0.7,1,100,100);
