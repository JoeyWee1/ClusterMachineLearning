...
k = 15; #Picking the number of nearest neighbours to consider
...
ax.scatter(xTest[:, 0],  xTest[:, 1],yTest , color = 'red', s = 0.5)
ax.scatter(xTest[:, 0],  xTest[:, 1],pred , color = 'blue', s = 0.5)
title = "Red is test values; Blue is predicted values; K = {}; Error = {:.2f}; Cluster {}".format(k,error,sc+1);
ax.set_title(title)
ax.set_xlabel('F074')
